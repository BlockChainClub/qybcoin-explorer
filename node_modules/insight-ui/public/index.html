...
<head>
  <base href="/" />
	...
	<title data-ng-bind="$root.title + $root.titleDetail + ' | QYB'">QYB</title>
	<meta name="keywords" content="bitcoins, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
	<meta name="description" content="Qybcoin Insight. View detailed information on all qybcoin transactions and block. {{ $root.title + $root.titleDetail }}">
...
<body ng-cloak class="ng-cloak">
  <div>
	...
	<div id="wrap">
		<div class="navbar navbar-default navbar-fixed-top" data-ng-include="'views/includes/header.html'" role='navigation' style="background-color: #333"></div>
