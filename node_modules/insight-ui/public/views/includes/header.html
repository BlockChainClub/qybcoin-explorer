<div class="container">
  <div data-ng-controller="HeaderController">
    <div class="navbar-header">
      ...
      <a class="insight navbar-brand" href="." style="color: yellow">QYB</a>
    </div>
    <div class="navbar-collapse collapse" collapse="$root.isCollapsed">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
      <div class="status" data-ng-controller="StatusController" style="background-color: yellow; color: #333">
