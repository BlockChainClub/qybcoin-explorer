  ...
  <div class="container">
    <div id="home" class="row">
      <div class="col-xs-12 col-md-12">
        ...
        <img src="/img/qyb/blue.png" width="100%" class="img-blue">
        ...
        <table class="table table-hover table-striped" style="table-layout: fixed;">
          ...
          <tr class="fader" data-ng-repeat='tx in txs'>
            ...
            <td class="text-right"><span class="ellipsis">{{$root.currency.getConvertion(tx.valueOut) || tx.valueOut + ' QYB'}}</span></td>
          </tr>
          </tbody>
        </table>
...
<!--
      <div class="col-xs-12 col-md-4 col-gray">
        ...
        <p translate><strong>insight</strong>  is an <a href="https://insight.is/"
          target="_blank">open-source Qybcoin blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by qybcoind RPC.  Check out the <a href="https://github.com/bitpay/insight-ui" target="_blank">source code</a>.</p>
